...
use abbau_expr::{parse_expr, Expr};
use abbau_types::{Attribute, Endian, KsySchema, TypeRef, TypeSpec, WellKnownTypeRef};
...
impl Enum {
    pub(crate) fn new(key: &str, _spec: &abbau_types::EnumSpec) -> Self {
